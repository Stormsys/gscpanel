<div class="content_pad">
	...
	<form class="admin_form" method="POST" action="/admin/dedicated-edit/<?=!isset($server) ? 'new' : $server->GetId();?>">
		...
		<label>
			<p>Nickname</p>
			<input name="nickname" type="text" value="<?=!isset($server) ? $post['nickname']: $server->GetNickname()?>" />
		</label>
		...
		<label>
			<p>SSH Port</p>
			<input name="ssh_port" type="text" value="<?=!isset($server) ? $post['ssh_port'] : $server->GetSSHPort()?>" />
		</label>

		<label>
			<p>SSH Username</p>
			<input name="ssh_username" type="text" value="<?=!isset($server) ? $post['ssh_username']: $server->GetSSHUsername()?>" />
		</label>
		<label>
			<p>SSH Password</p>
			<input name="ssh_password" type="password" value="<?=!isset($server) ? $post['ssh_password']: $server->GetSSHPassword()?>" />
		</label>

		<label>
			<p>Game Files Directory</p>
			<input name="installs_dir" type="text" value="<?=!isset($server) ? $post['installs_dir']: $server->GetInstallDir()?>" />
		</label>
