            ...
            <tr>
                ...
                <td class="phone-hidden">
                    <?php if (!empty($server['user_id'])): ?>
                        <a href="/admin/user-edit/<?= $server['user_id'] ?>"><?= $server['user_username'] ?>
                            (<?= $server['user_name'] ?>)</a>
                    <?php else: ?>
                        (no user)
                    <?php endif; ?>
                ...
                <td class="phone-hidden center">
                    <div class="gs-status" data-status="<?= GameServerStatus::$STYLE_TEXT[$server['online_status']] ?>">
                        &nbsp;</div>
                </td>
                <td><a href="/dashboard/manage/<?= $server['gs_id'] ?>" class="manage-button">&nbsp;</a> <a
                        href="/admin/gameserver-edit/<?= $server['gs_id'] ?>" class="edit-button">&nbsp;</a> <a
                        href="/admin/gameserver-delete/<?= $server['gs_id'] ?>" class="delete-button">&nbsp;</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
